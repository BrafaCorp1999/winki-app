...
const babyPinkUltraLight = Color(0xFFFFF0F9); // Más clarito aún
const softGold = Color(0xFFFFD700);


class TColors {
  // App theme colors
  static const Color primary = Color(0xFFD4B170);
  static const Color secondary = Color(0xFFFFE24B);
  static const Color accent = Color(0xFFb0c7ff);
  static const Color babyPinkUltraLight = Color(0xFFFFF0F9);
  static const Color softGold = Color(0xFFFFD700);
  static const Color pink = Color(0xFFF5DDD8);
  static const Color gold = Color(0xFFD4B170);
