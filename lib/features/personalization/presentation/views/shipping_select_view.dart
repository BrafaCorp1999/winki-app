...
class ShippingSelectionView extends StatefulWidget {
  const ShippingSelectionView({super.key});

  @override
  State<ShippingSelectionView> createState() => _ShippingSelectionViewState();
}

class _ShippingSelectionViewState extends State<ShippingSelectionView> {
  ...
  Container(
         ...
         margin: const EdgeInsets.symmetric(horizontal: 2),
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    // Navegar después de 300ms (para feedback visual)
                  ...
                  child: _buildShippingOption(
                    ...
                    subtitle: 'Casa / Oficina',
                    isSelected: _isSelected,
                    //isEnabled: true, // Solo esta opción está habilitada
                  ),
                ),
    Container(
        height: 2,        
    ...
    //),
                ...
                //     onPressed: () {
                //       // Navegar a la siguiente pantalla (Pago)
  ...
  Widget _buildShippingOption({
    ...
    return Container(
      ...
      //   borderRadius: BorderRadius.circular(12),
      //   border: Border.all(
      //     color: isSelected ? const Color(0xFFF28482) : Colors.grey[300]!,
      //     width: 2,
      //   ),
      // ),
      child: Row(
        children: [
          Icon(
            ...
            color: isSelected ? const Color(0xFFF28482) : Colors.grey,
          ),
